...
(function($, undefined) {
    ...
    $.widget("jb.overflowmenu", {
        ...
        _create: function() {
            ...
            this.element
                .addClass('jb-overflowmenu jb-overflow-disabled');
            ...
            this.secondaryMenuContainer = $(
                [
                    ...
                    '<a href="javascript://" class="jb-overflowmenu-menu-secondary-handle icon-keyboard-control"><span class="visuallyhidden">More</span></a>',
        ...
        destroy: function() {
            // Put items back into original menu before destroying 
            this.secondaryMenu
                .children()
        ...
        refresh: function() {
            ...
            if (this.secondaryMenu.children().length < 1) {
                this.element
                .addClass('jb-overflow-disabled');
            }
