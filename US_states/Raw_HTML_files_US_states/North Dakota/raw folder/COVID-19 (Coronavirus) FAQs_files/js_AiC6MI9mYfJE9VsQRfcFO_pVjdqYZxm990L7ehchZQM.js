(function ($) {
  ...
  Drupal.behaviors.itdbased8 = {
    attach: function(context, settings) {
      	var form_url = window.location.href;
        $("input[name='page_url']").val(form_url);
        embed360('.embed360');
        $(".paragraphs-frontend-uiduplicate a").click(function(){
            setTimeout(function() {
                location.reload(true);
            }, 2000); 
        });

        //Equal Heights for Cards on Map Page
        var maxHeight = 0;

        $(".paragraph--type--map div.featured-card").each(function(){
           if ($(this).height() > maxHeight) { maxHeight = $(this).height(); }
        });

        $(".paragraph--type--map div.featured-card").height(maxHeight);
