...
(function($) {
  $(document).ready(function() {
    $('[href*="/sites/www/files/"]').each(function () {
        if ($(this).parents('.paragraph').length > 0 && $(this).closest('.btn').length !== 1 && $(this).parents('.featured-list').length === 0 && $(this).parents('.featured-card').length === 0 && $(this).parents('.paragraph--type--_-column-featured-area').length === 0) {
            var n = this.toString();
            ...
            switch(n) {
                ...
                case ".doc":
                case ".odt":
                    $(this).append("<i class='far fa-file-word'></i>");   
                    break;
                case ".csv":
                    $(this).append("<i class='fas fa-file-csv'></i>");
                    break;
                case ".rtf":
                case ".txt":
                case ".wpd":
                case ".wps":
                    $(this).append("<i class='far fa-file-alt'></i>");
                    break;
                case ".pps":
                case ".ppt":
                case ".pptx":
                    $(this).append("<i class='far fa-file-powerpoint'></i>");
                    break;
                case ".xlr":
                case ".xls":
                case ".xlsx":
                    $(this).append("<i class='far fa-file-excel'></i>");
                    break;
                case ".m4a":
                case ".mid":
                case ".mp3":
                case ".wave":
                case ".wma":
                    $(this).append("<i class='far fa-file-audio'></i>");
                    break;
                case ".avi":
                case ".m4v":
                case ".mp4":
                case ".wmv":
                    $(this).append("<i class='far fa-file-video'></i>");
                    break;
                case ".gif":
                case ".jpg":
                case ".png":
                case ".svg":
                    $(this).append("<i class='far fa-file-image'></i>");
                    break;
                case ".7z":
                case ".rar":
                case ".zip":
                    $(this).append("<i class='far fa-file-archive'></i>");
                    break;                                    
                case ".pdf":
                    $(this).append("<i class='far fa-file-pdf'></i>");
                    break;           
                default:
                    $(this).append("<i class='far fa-file'></i>");                    
            }
       }
	}
)});
