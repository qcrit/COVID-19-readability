...
this._eventMap.addHandlerForClassName("mouseout",n,this._onItemMouseOut);
...
this._eventMap.addHandlerForClassName("mouseout",p,this._onLinkMouseOut);
...
if(!K&&!this._isMainElementDescendant(J.target)){var L=this;
setTimeout(function(){L.close();
},this.get_collapseDelay());
}},_onClick:function(K){if(!this._isMainElementDescendant(K.target)){var J=this.get_clickToOpen();
