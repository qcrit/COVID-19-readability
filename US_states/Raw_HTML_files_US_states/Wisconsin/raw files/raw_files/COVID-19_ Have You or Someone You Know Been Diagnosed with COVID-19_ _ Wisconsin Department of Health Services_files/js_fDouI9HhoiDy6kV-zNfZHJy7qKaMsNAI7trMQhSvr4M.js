...
(function ($, window, document) {
    ...
    AccessibleMegaMenu.prototype = (function () {
        ...
        _delayedMouseOverHandler = function(event, that) {
          $(event.target)
        ...
        _mouseOverHandler = function (event) {
            ...
            //this.mouseTimeoutID = setTimeout(_delayedMouseOverHandler, 500, event, this);
            //return;
            $(event.target)
        ...
        return {
            ...
            init: function () {
                ...
                menu.find('.' + settings.topNavItemClass).hoverIntent({
